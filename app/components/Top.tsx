...
export default function Top() {
	...
	return (
		<motion.button
			...
			animate={controls}
			initial='hide'
			className='w-12 h-12 fixed bottom-8 right-8 md:bottom-12 md:right-12 z-40 text-3xl flex justify-center items-center bg-white dark:bg-stone-900 rounded-sm shadow-md border dark:hover:bg-stone-700 border-gray-300 hover:text-black dark:hover:text-white dark:text-stone-100 text-gray-400 hover:shadow-lg cursor-pointer'
			onClick={scrollToTop}>
			<UpArrow></UpArrow>
		</motion.button>
	);
